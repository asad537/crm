...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // NOTE: gzip is handled by nginx (docker/nginx.conf). App-level gzip here
            // caused a double-compression (nginx re-gzipped) → corrupted body / blank page.
    ...
    protected $middlewareAliases = [
        ...
        'crm.admin' => \App\Http\Middleware\CrmAdminOnly::class,
        'crm.admin_manager' => \App\Http\Middleware\CrmAdminOrManager::class,
    ];
}
