...
<span class="vp-expense-type {{ $vendor->category === 'Consumable Expense' ? 'personal' : '' }}">{{ $vendor->category ?: 'Production Expense' }}</span></td><td>
