            ...
            <tr>
                ...
                <td>
                    <div class="or-acts">
                        ...
                        <a class="or-act edit" href="{{ route('crm.orders.manual.edit',$order->id) }}"><i class="fas fa-pen"></i> Edit</a>
                        <a class="or-act" href="{{ route('crm.orders.manual.pdf',$order->id) }}" target="_blank"><i class="fas fa-file-pdf"></i> View PDF</a>
